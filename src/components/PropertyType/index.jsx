...
const PropertyTypeCard = ({ card }) => {
  return (
    <Card sx={{display:'flex', width:'688px', height:'258px',padding:'20px', gap:'24px', borderRadius:'20px'}}>
        <Box sx={{flex:1}}>
...
const PropertyType = () => {
  ...
  return (
     ...
     <Grid
      ...
      >
    <Typography variant='p' sx={{fontWeight: 700, fontSize: '32px', lineHeight: '37px', color: '#000000', margin:'0 0 40px 120px'}}>Offers</Typography>
